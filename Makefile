...
task-example: main.o executive.o task-example.o excstate.o
	gcc ${FLAGS} -o task-example main.o executive.o task-example.o excstate.o -lpthread -lrt

task-err: main.o executive.o task-err.o excstate.o
	gcc ${FLAGS} -o task-err main.o executive.o task-err.o excstate.o -lpthread -lrt

task-sp: main.o executive.o task-sp.o excstate.o
	gcc ${FLAGS} -o task-sp main.o executive.o task-sp.o excstate.o -lpthread -lrt

task-sp-err: main.o executive.o task-sp-err.o excstate.o
	gcc ${FLAGS} -o task-sp-err main.o executive.o task-sp-err.o excstate.o -lpthread -lrt

task-sp-err-wcet: main.o executive.o task-sp-err-wcet.o excstate.o
	gcc ${FLAGS} -o task-sp-err-wcet main.o executive.o task-sp-err-wcet.o excstate.o -lpthread -lrt

main.o: main.c
	gcc ${FLAGS} -Wall -c main.c -lpthread -lrt

executive.o: executive.c executive.h
	gcc ${FLAGS} -Wall -c executive.c -lpthread -lrt
...
clean:
	rm -f *.o *~ task-example task-err task-sp task-sp-err task-sp-err-wcet
